...
import Comingsoonimage from '@/components/comingsoon/Image';
    ...
    <Layout>
      ...
      <main>
        <section className='Coming Soon'>
          <div className='font-poppins m-auto flex min-h-screen w-full self-center bg-background-cream '>
            <div className='m-auto flex  flex-col     '>
              <div className='m-auto flex flex-col'>
                <Comingsoonimage />
                <div className='px-7 pt-7 text-center text-3xl font-bold sm:px-3 sm:text-4xl md:pt-6 md:text-5xl lg:pt-5 lg:text-6xl'>
